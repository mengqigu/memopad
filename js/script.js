...
// Map newNote to the display name
var translations = {
    newNote: $('#new-note-string').text()
};

// Constructor for object Notes.
// this notes object holds all our notes
var Notes = function (baseUrl) {
    // baseURl is generated using OCP
    this._baseUrl = baseUrl;

    // An array of note objects. Note objects are created in button callbacks
    this._notes = [];
    this._activeNote = undefined;
};

// Overwrite the prototype object for constructor funtion Notes
Notes.prototype = {
    // Load note with id
    load: function (id) {
        var self = this;
    ...
    /**
     * Creating a node by sending a request to the backend and add to this._notes if successful.
     * @param  note a Node object
     * @return
     */
 ...
 * A view instance contains one Notes instance.
 * this will be the view that is used to update the html
 * @param  {Notes} notes an instance of Notes object
 */
...
var notes = new Notes(OC.generateUrl('/apps/memopad/notes'));
